...
class DefaultAssetLibrary extends AssetLibrary {
	...
	public function new () {
		...
		Font.registerFont (__ASSET__assets_fonts_lcd_solid_ttf);
		
		
		Font.registerFont (__ASSET__assets_fonts_visitor1_ttf);
...
@:keep class __ASSET__assets_fonts_lcd_solid_ttf extends openfl.text.Font { public function new () { super (); __fontPath = "assets/fonts/LCD_Solid.ttf"; fontName = "LCD Solid"; }}
@:keep class __ASSET__assets_fonts_visitor1_ttf extends openfl.text.Font { public function new () { super (); __fontPath = "assets/fonts/visitor1.ttf"; fontName = "Visitor TT1 BRK"; }}
...
class __ASSET__assets_fonts_lcd_solid_ttf extends openfl.text.Font { public function new () { super (); __fontPath = "assets/fonts/LCD_Solid.ttf"; fontName = "LCD Solid";  }}
class __ASSET__assets_fonts_visitor1_ttf extends openfl.text.Font { public function new () { super (); __fontPath = "assets/fonts/visitor1.ttf"; fontName = "Visitor TT1 BRK";  }}
...
@:keep #if display private #end class __ASSET__assets_fonts_lcd_solid_ttf extends lime.text.Font { public function new () { __fontPath = #if ios "assets/" + #end "assets/fonts/LCD_Solid.ttf"; name = "LCD Solid"; super (); }}
@:keep #if display private #end class __ASSET__assets_fonts_visitor1_ttf extends lime.text.Font { public function new () { __fontPath = #if ios "assets/" + #end "assets/fonts/visitor1.ttf"; name = "Visitor TT1 BRK"; super (); }}
...
#if (openfl && !flash)
@:keep #if display private #end class __ASSET__OPENFL__assets_fonts_lcd_solid_ttf extends openfl.text.Font { public function new () { __fontPath = #if ios "assets/" + #end "assets/fonts/LCD_Solid.ttf"; name = "LCD Solid"; super (); }}
@:keep #if display private #end class __ASSET__OPENFL__assets_fonts_visitor1_ttf extends openfl.text.Font { public function new () { __fontPath = #if ios "assets/" + #end "assets/fonts/visitor1.ttf"; name = "Visitor TT1 BRK"; super (); }}
