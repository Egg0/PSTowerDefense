...
class Tutor7 extends PlayState {

    // Single path, no equipment
    override public function create():Void {
        _map = new FlxOgmoLoader("assets/data/debug_vertical.oel");
        ...
        level_hud.setWaveString("T7");
    }

    override function setPreLevelHUD():Void {
        super.setPreLevelHUD();
        hint = new OpenFlxText(30, FlxG.height - 40, 0, "Be strategic about your tower placement...", 12);
        add(hint);
